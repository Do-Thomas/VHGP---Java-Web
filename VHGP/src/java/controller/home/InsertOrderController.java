        ...
        try {
            ...
            if (set != null) {
                for (Integer id : set) {
                    ...
                    String teaString = request.getParameter("addressPhone");
                    String[] tmp = teaString.split("-");
                    String CustomerAddress = tmp[0];
                    String Phone = tmp[1];
                    
//                    Customer_contact contact = CustomerContactDAO.getCustomerbyPhoneCS(Phone);
//                    String PhoneCustomer = contact.getCustomer().getPhone();
//                    Customer customer = dao.getAccountbyPhone(Phone);

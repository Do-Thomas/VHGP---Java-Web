...
public class CancelOrder extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            Set<Integer> setEmployee = (Set<Integer>) session.getAttribute("EMPLOYEE");
            for (Integer IDemp : setEmployee) {
                Employee employee = employeeDAO.getEmployeeByID(IDemp);
                employeeDAO.updateEmployeeStatus(employee);
            }
//            OrderDetail orderItem = (OrderDetail) session.getAttribute("ORDER_DETAIL");

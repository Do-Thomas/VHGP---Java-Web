 ...
 * @author Asus
 */
@WebServlet(name = "ListAllServices", urlPatterns = {"/ListAllServices"})
public class ListAllServices extends HttpServlet {

    private static final String ERROR = "error.jsp";
    private static final String SUCCESS = "ListAllServices.jsp";
...
//            request.setAttribute("NOTIFICATION", list);
            ...
            List<Services> listServices = dao.read();
            if (listServices.size() > 0) {
                request.setAttribute("LIST_SERVICES", listServices);
                url = SUCCESS;
            }
        } catch (Exception e) {

...
//                listItem.add(item);
    ...
    public List<Order> getManageOrder() throws ParseException {
        List<Order> listItem = new ArrayList<>();
        CategoryDAO catD = new CategoryDAO();
        StatusDAO statusDAO = new StatusDAO();
        OrderDetailDAO OrderDetailDAO = new OrderDetailDAO();
...
//        }
//        List<Order> list = o.getOrderList(9);
//        for (Order order : list) {
//            System.out.println("==============================================================");
//            System.out.println("Dịch vụ: " + order.getOrderDetail().getOrderDServiceName());
//            System.out.println("Bắt đầu: " + order.getOrderDetail().getTimeStart());
//            System.out.println("Kết thúc: " + order.getOrderDetail().getTimeEnd());
//    
    }
}

...
//        Services s = new Services(2, "Dọn dẹp nhà cửa", "a", "donnha.jsp");
//        Date date = new Date(2023, 06, 23);
//        Customer c = new Customer(1, "Trần Văn A", "0123456781", "12345", date, "S101, 1999", true);
//        String title = "Dọn dẹp";
//        Date data = new Date(2023, 06, 26);
//        int rating = 3;
//        String comment = "None";
//        String picture = "donnha.jpg";
//        Reviews r = new Reviews(title, date, rating, comment, picture, s, c);
//        dao.createFeedBack(r);
        List<Reviews> list = dao.getListFeedback();

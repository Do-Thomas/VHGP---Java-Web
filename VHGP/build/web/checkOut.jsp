        ...
        <div class="container"> 
            <div class="row">
                <div class="col-md-4 order-md-2 mb-4">
                    ...
                    <a class="btn btn-primary btn-lg btn-block" href="ViewCart.jsp">Quay lại giỏ hàng</a>
                ...
                <div class="col-md-8 order-md-1">
                    ...
                    <form action="MainController" method="POST">
                        ...
                        <select class="btn select-address" required name="addressPhone" onchange="updateAddressPhone(this)">
                            <option value="">Chọn địa chỉ và số điện thoại</option>
                            <c:forEach items="${Listaddress}" var="users">
                                <option value="${users.customerAddress} - ${users.phone}">
                                    ${users.customerAddress} - ${users.phone}
                                </option>
                            </c:forEach>
                        </select>
                        ...
                        <div class="pay">
                            <input type="radio" id="COD" class="option-input radio" name="Pay" value="COD"><label for="html">Thanh toán khi hoàn thành</label>
                        </div>
                </div>
                <div>
            ...
            <div class="insert">
                ...
                <a class="cancel" href=""><input class="btn btn-primary btn-lg btn-block" type="submit" name="action" value="Cancel"></a>
            </div>
        </form> 

...
<body>
                ...
                <div class="site-navigation">
                    ...
                    <ul class="js-clone-nav d-none d-lg-inline-block text-start site-menu float-end">
                        ...
                        <li class="has-children">
                            <a href="CategoryHome">Category</a>
                            <ul class="dropdown">
    ...
    <div class="hero">
        <div class="hero-slide">
            <div class="img overlay tns-item img-banner" style="background-image: url('image/banner2.jpg'); height:50%"></div>
        </div>
    ...
    <!--    <div class="box">
            <form action="MainController"  >
                <input class="gg" type="text" name="search" placeholder="search..." value="${param.search}" />
                <input type="submit" class="btn btn-primary" name="action" value="Search"/>  <a class="se" href="ViewCart.jsp" > <img src="https://cdn.pixabay.com/photo/2013/07/12/14/53/cart-148964_1280.png" alt="se" style="width:20px;height:20px" /></br></a>
            </form>
            <i class="fas fa-search"></i>
        </div>-->
...
<!--                                         <span class="city d-block mb-3">${s.catID}</span>-->
                                    <b class="city d-block mb-3 text-black-50">${s.serviceDetail}</b>

<!--                                        <a href="MainController?id=${s.serviceName}&action=Detail" class="btn btn-primary py-2 px-3">See details</a>-->
                                </div>
                            </div>
                        </div>
                    </div>

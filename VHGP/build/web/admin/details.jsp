                ...
                <div class="container">
                    <div class="row justify-content-between">
                        ...
                        <div class="col-lg-4">
                            ...
                            <h2> <em>  <b class="meta" style="color:black">${pro.servicePrice}00VNĐ</b></em></h2>
                            <h2> <em>  <b class="meta" style="color:black">${pro.serviceTime}giờ</b></em></h2>
                            <h2> <em>  <b class="meta" style="color:black">${pro.catID.catID}</b></em></h2>
...
<!--                                           <a href="MainController?id=${pro.serviceID}&action=List" class="btn btn-primary py-2 px-3">Back</a>-->
<!--                            <a class="btn btn-primary py-2 px-3" href="MainController?cmbTea=${pro.serviceID}-${pro.serviceName}-${pro.servicePrice}&cmbQuantity=1&action=Add">Order</a>-->

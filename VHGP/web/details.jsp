                        ...
                        <div class="wrapper">
                            <form action="MainController">
                                ...
                                <c:forEach items="${requestScope.DETAILS_SERVICE}" var="pro" varStatus="counter">
                                    ...
                                    <div class="box">
                                        <input type="radio" name="cmbTea" id="option-${counter.count}" value="${pro.serviceID}-${pro.serviceName}-${pro.servicePrice}-${pro.serviceDetail}-${pro.serviceTime}-${pro.servicePicture}">
                                        <label for="option-${counter.count}" class="option-${counter.count}">
                                            <div class="dot"></div>
                                            <div class="text">${pro.serviceTime}giờ - ${pro.servicePrice}00VNĐ</div>
                                        </label>
                                    </div>
                                ...
                                <div class="button-group">
                                    <div class="button-container">
                                        ...
                                        <a><input class="btn btn-primary py-2 px-3 add-to-cart" href="MainController?cmbTea=${pro.serviceID}-${pro.serviceName}-${pro.servicePrice}-${pro.serviceDetail}-${pro.serviceTime}-${pro.servicePicture}&action=Add" type="submit" value="ADD"></a>
                                    </div>
                                    <div class="button-container">

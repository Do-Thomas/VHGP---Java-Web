<%-- 
    Document   : ViewAdmin
    Created on : Jun 16, 2023, 10:08:18 AM
    Author     : hathao
--%>
    ...
    <body>
        ...
        <div class="all">
            <div class="side-menu">
                ...
                <div class="menu">
                    <ul>
                        <li><a href="admin"><i class="fa fa-server" aria-hidden="true"></i><span class="text"> Pages </span></a>
                            <ul class="dropdown">
                    ...
                    <div class="card h-100">
                        <div class="card-body">
                            <div class="row gutters">
                                ...
                                <c:if test="${requestScope.DETAILS_ADMIN != null}">
                                    <c:if test="${ not empty requestScope.DETAILS_ADMIN}">
                                        <c:forEach items="${requestScope.DETAILS_ADMIN}" var="pro" varStatus="counter">

                                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                <div class="form-group">
                                                    <label for="fullName">Full Name</label>
                                                    <input type="text" class="form-control" id="fullName" placeholder="Enter full name" value="${pro.usernameAdmin}" readonly >
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                <div class="form-group">
                                                    <label for="eMail">Email</label>
                                                    <input type="email" class="form-control" id="eMail" placeholder="Enter email ID" value="${pro.mailAdmin}" readonly >
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                <div class="form-group">
                                                    <label for="phone">Password</label>
                                                    <input type="password" class="form-control" id="phone" placeholder="Enter phone number" value="${pro.passAdmin}" readonly >
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                <div class="form-group">
                                                    <label for="phone">Role</label>
                                                    <input type="text" class="form-control" id="phone" placeholder="Enter phone number" value="${pro.roleID.roleID}" readonly >
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row gutters">
                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                            <div class="text-right">
                                                ...
                                                <a href="UpdateAdmin?usernameAdmin=${pro.usernameAdmin}" class="btn btn-primary">Update profile</a>
                                            </div>
                                        </div>
                                    </div>
                                </c:forEach>

...
<!--                    <div class="timeline">
                        <ul>
                            <li class="time-scheledu"><span>07:00</span></li>
                            <li class="time-scheledu"><span>12:00</span></li>
                            <li class="time-scheledu"><span>17:00</span></li>
                            <li class="time-scheledu"><span>21:00</span></li>
                        </ul>
                    </div>  .timeline -->
                    <div class="events">
                        <ul class="wrap">
                            ...
                            <%
                                ArrayList<OrderDetail> list = (ArrayList) request.getAttribute("LIST_JOB");
                            %>

                            <%
                                for (OrderDetail od : list) {
                                    Calendar calendar = Calendar.getInstance();
                                    calendar.setTimeInMillis(od.getTimeStart().getTime());
                                    Locale loc = new Locale("EN", "US");
                                    String date = calendar.getDisplayName(Calendar.DAY_OF_WEEK, Calendar.LONG_FORMAT, loc);
                                    SimpleDateFormat dateFormat = new SimpleDateFormat("dd/MM/yyyy HH:mm:ss");
                                    String timeStart = dateFormat.format(od.getTimeStart());
                                    String timeEnd = dateFormat.format(od.getTimeEnd());
                            %>

                            <% if (!date.equals(date)) {%>
                            <li class="events-group">
                                <div class="top-info"><span><%=date%></span></div>
                                <ul>
                                    <li class="single-event" data-start="<%=timeStart%>" data-end="<%=timeEnd%>" data-content="event-abs-circuit" data-event="event-1">
                                        <a href="#0">
                                            <em class="event-name"><%=od.getOrderDServiceName()%></em>
                                        </a>
                                    </li>
                                </ul>
                            </li>

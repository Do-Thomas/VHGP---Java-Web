...
<!--    ${requestScope.MESSAGE}</a>-->
    ...
    <c:if test="${requestScope.LISTPZA_SERVICES != null}">
        <c:if test="${ not empty requestScope.LISTPZA_SERVICES}">                                
            <div class="row">
                <c:forEach items="${requestScope.LISTPZA_SERVICES}" var="pro" varStatus="counter">
                    <div class="col-sm-4">

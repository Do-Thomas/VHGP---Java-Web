...
//    CustomerContactDAO customerContactDAO = new CustomerContactDAO();
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (customer != null) {
            ...
            if (!isValidPhoneNumber(Phone)) {
            ...
            } else if (!CustomerAddress.startsWith("S")) {
                request.setAttribute("error", "Địa chỉ không hợp lệ. Vui lòng nhập lại.");
                ...
                try {
                    ...
                    if (customerContactDAO.checkDuplicateContact(Phone, CustomerAddress)) {

 ...
 * @author Asus
 */
@WebServlet(name = "Test", urlPatterns = {"/CreateStatusOrder"})
public class CreateStatusOrder extends HttpServlet {

    private static final String ERROR = "error.jsp";
    private static final String SUCCESS = "ShowBillController";
        ...
        try {
            ...
            if (set != null) {
                for (Integer OrderID : set) {
                    ...
                    int EmployeeID = Order.getEmployee().getEmployeeID();

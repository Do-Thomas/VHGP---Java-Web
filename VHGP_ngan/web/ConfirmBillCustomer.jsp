                                                        ...
                                                        <div class="panel">
                                                            <div class="notifications clearfix">
                                                                ...
                                                                <div class="notification">
                                                                    ...
                                                                    <h2><b>Hóa đơn</b></h2>
                                                                    <h3>Tên khách hàng <b class="info">${b.customer.customerName}</b></h3>
                                                                    <h3>Số điện thoại <b class="info">${b.customer.phone}</b></h3>                       

                                                                    <h3 class="service"> ${b.status.orderDetail.orderDServiceName} - ${b.status.employee.employeeName}</h3>
                                                                    <h3>Thời gian <b class="info"><fmt:formatDate pattern="dd/MM/yyyy hh:mm:ss aaa" value="${timeStart}"/>  - <fmt:formatDate pattern="dd/MM/yyyy hh:mm:ss aaa" value="${timeEnd}"/></b></h3>
                                                                    <h3>Hình thức thanh toán <b class="info">${b.status.orderDetail.pay}</b></h3>
                                                                    <h3>Tổng <b class="info">${total}00 VND</b></h3>
                                                                    <a class="button-finished" href="ConfirmService?StatusID=${b.status.statusID}">Hoàn tất</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>

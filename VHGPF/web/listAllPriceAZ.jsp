...
<!--                        <li><a href="listServices.jsp">About</a></li>
    ...
    <div class="drop">                       
        <div class="dropdown2">
            ...
            <div class="dropdown-content">
                <a href="IndexServices">Nổi bật</a>
    ...
    <style>
        ...
        .dropdown2:hover .dropbtn {background-color: #143b15;}
    </style>
    <div class="container">
        <div class="box row  ">
            <div class="col-lg-9 text-center">
    ...
    <c:if test="${requestScope.LISTPAZ_SERVICES != null}">
        <c:if test="${ not empty requestScope.LISTPAZ_SERVICES}">                                
            <div class="row">
                <c:forEach items="${requestScope.LISTPAZ_SERVICES}" var="pro" varStatus="counter">
                    <div class="col-sm-4">

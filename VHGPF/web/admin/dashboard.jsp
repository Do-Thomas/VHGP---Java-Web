    ...
    <div class="all">
        ...
        <div class="wrapper">
            ...
            <body onload="time()" class="app sidebar-mini rtl">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-lg-6">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="tile">
                                        <h3 class="tile-title">Tiền 7 tháng đầu năm</h3>
                ...
                <!--===============================================================================================-->
                <canvas id="barChartDemo" width="400" height="200"></canvas>
                <script src="https://cdn.jsdelivr.net/npm/chart.js"></script>
                ...
                var comboChart = new Chart(ctx, {
                    ...
                    ${requestScope.tien7}
                                ...
                                backgroundColor: 'rgba(0, 128, 0, 0.5)', // Màu sắc cho cột doanh thu (màu xanh lá đậm)
                                borderColor: 'rgba(0, 128, 0, 1)',
                                borderWidth: 1,
                                yAxisID: 'revenue-y-axis', // Gán dataset này với trục Y tên 'revenue-y-axis'
                            }
                        ]
                    },
                    options: {
                        scales: {
                            ...
                            'profit-y-axis': {// Định nghĩa trục Y cho lợi nhuận
                                type: 'linear',
                                display: true,
                                position: 'right',
                                ticks: {
                ...
                // Thêm dataset lợi nhuận vào biểu đồ
                comboChart.data.datasets.push({
                    type: 'line',
                    data: [
                    ${requestScope.loiNhuan1},
                    ${requestScope.loiNhuan2},
                    ${requestScope.loiNhuan3},
                    ${requestScope.loiNhuan4},
                    ${requestScope.loiNhuan5},
                    ${requestScope.loiNhuan6},
                    ${requestScope.loiNhuan7}
                    ],

                    borderWidth: 2,
                    fill: false,
                    yAxisID: 'profit-y-axis' // Gán dataset này với trục Y tên 'profit-y-axis'
                });

...
<!--                        <div class="search">
                ...
                <div class="section section-properties ">  
                    <a href="MainController?Id=${pro.catID}&action=CreateCat" class="btn btn-hover color-1">Create</a>
                    <div class="container">
                        <div class="row ">
                            ${requestScope.MESSAGE}
                            <c:if test="${requestScope.LIST_CATEGORY != null}">
                                <c:if test="${ not empty requestScope.LIST_CATEGORY}">
                                    <c:forEach items="${requestScope.LIST_CATEGORY}" var="pro" varStatus="counter">
                                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4">
                                            <div class="property-item mb-30">
                                                <a href="" class="img">
                                                    <img src="image/icon/${pro.catPicture}" width="100%" height="400" alt="Image" class="img-fluid">
                                                </a>
                                                <div class="property-content">
                                                    <div class="price mb-2"><span>${pro.catName}</span></div>
                                                    <form action="MainController">
                                                        <div>
                                                            <span class="d-block mb-2 text-black-50">Mã: ${pro.catID}</span>
                                                            <span class="city d-block mb-3">${pro.catStatus}</span>                                              
                                                            <a href="MainController?Id=${pro.catID}&action=UpdateCat" class="btn btn-primary py-2 px-3">Update</a>
                                                            <a href="MainController?id=${pro.catID}&action=Show" class="btn btn-primary py-2 px-3">See details</a>
                                                        </div>
                                                    </form>
                                                </div> 
                                            </div>

 ...
 * @author Asus
 */
@WebServlet(name = "AllEmployee", urlPatterns = {"/AllEmployee"})
public class AllEmployeeController extends HttpServlet {

    private static final String ERROR = "error.jsp";
    private static final String SUCCESS = "AllEmployee.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            int Count = empDAO.getCountEmployee();
            
            request.setAttribute("COUNT_EMP", Count);

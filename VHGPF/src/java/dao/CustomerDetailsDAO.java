...
public class CustomerDetailsDAO {
    ...
    public CustomerDetail getCustomerDetail(int OrderID) {
        try {
            String sql = "select *\n"
            ...
            while (rs.next()) {
                ...
                int Order = Integer.parseInt(rs.getString("OrderID"));
                ...
                CustomerDetail item = new CustomerDetail(CustomerDID, CustomerAddress, Phone, c, o);
                return item;
            }
...
//        System.out.println(cu);
        CustomerDetail item = dao.getCustomerDetail(123);
        System.out.println("Khách hàng: " + item.getCustomer().getCustomerName());
    }
}

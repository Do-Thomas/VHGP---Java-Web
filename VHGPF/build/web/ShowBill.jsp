        ...
        <c:if test="${requestScope.BILL != null}">
            <c:if test="${ not empty requestScope.BILL}">
                <c:forEach items="${requestScope.BILL}" var="b" varStatus="counter">
                    ...
                    <c:set var="price" value="${b.orderDetail.orderDServicePrice}"/>
                    ...
                    <table width="100%" style="border-collapse: collapse;border-bottom:1px solid #eee;">
                        ...
                        <tr>
                            <td >${b.orderDetail.orderDServiceName}</td>
                            <td >${b.orderDetail.orderDServicePrice}00 VND</td>
                            <td ><fmt:formatDate pattern="dd/MM/yyyy hh:mm:ss aaa" value="${timeStart}"/> </td>
                            <td ><fmt:formatDate pattern="dd/MM/yyyy hh:mm:ss aaa" value="${timeEnd}"/></td>
                        </tr>

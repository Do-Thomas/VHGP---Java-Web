                                        ...
                                        <form action="AllManage" method="POST"> 
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <input type="datetime-local" value="${o.orderDetail.timeStart}" name="TimeStart">
                                                </td>
                                                <td>
...
<!--                                                        <i class="bg-warning"><a href="${up}" class="btn btn-primary py-2 px-3"><i class="fa fa-edit"></i></a></i>-->
                                                        ...
                                                        <a class="btn-cancel" onclick="myFunction()" href="CancelManage?OrderID=${o.orderID}"><img class="img-cancel" src="../image/icon/"></a> 
                                                    </span>
                                                </td>

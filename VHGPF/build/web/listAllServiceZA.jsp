...
<!--                        <li><a href="listServices.jsp">About</a></li>
    ...
    <c:if test="${requestScope.LISTZA_SERVICES != null}">
        <c:if test="${ not empty requestScope.LISTZA_SERVICES}">                                
            <div class="row">
                <c:forEach items="${requestScope.LISTZA_SERVICES}" var="pro" varStatus="counter">
                    <div class="col-sm-4">

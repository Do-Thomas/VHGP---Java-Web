...
<html>
    ...
    <body>
        ...
        <c:if test="${not empty errorMap}">
            <p style="color: red;">Error(s) occurred:</p>
            <ul>
                <c:forEach var="errorEntry" items="${errorMap}">
                    <li>${errorEntry.value}</li>
                    </c:forEach>
            </ul>
        </c:if>

        <h1 id="title">Create Marketing</h1>

        <%-- Display form --%>
        <form action="CreateMarketing" method="post">

            <div class="form-control">
                <label for="Event" id="name-label">Event : </label>
                <input type="text" id="Event" name="Event" placeholder="Enter Event" value="${empty param.Event ? '' : param.Event}">
            </div>

            <div class="form-control">
                <label for="ServiceID" id="name-label">Service ID:</label>
                <select id="ServiceID" name="ServiceID">
                    <option value="">Select Service ID</option>
                    <%-- Loop through services and display service IDs --%>
            ...
            <div class="form-control">
                ...
                <div class="input-group date" id="startTimePicker" data-target-input="nearest">
                    <input type="text" class="form-control datetimepicker-input" id="StartTime" name="StartTime" data-toggle="datetimepicker" data-target="#startTimePicker" placeholder="Enter Start Time" value="${empty param.StartTime ? '' : param.StartTime}" />
            ...
            <div class="form-control">
                ...
                <div class="input-group date" id="endTimePicker" data-target-input="nearest">
                    <input type="text" class="form-control datetimepicker-input" id="EndTime" name="EndTime" data-toggle="datetimepicker" data-target="#endTimePicker" placeholder="Enter End Time" value="${empty param.EndTime ? '' : param.EndTime}" />
            ...
            <div class="form-control">
                ...
                <input type="number" id="Voucher" name="Voucher" placeholder="Enter Voucher" value="${empty param.Voucher ? '' : param.Voucher}">
            </div>
            ...
            <input type="submit" id="submit" value="CreateMarketing">
        </form>
    </body>
</html>

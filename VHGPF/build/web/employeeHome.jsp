    ...
    <head>
        ...
        <style>
            ...
            * {
            ...
            /* Add these styles for the row-emp container */
            .row-emp {
                display: flex;
                flex-wrap: wrap;
            ...
            /* Adjust the width of each column to create three columns on the same row */
            .frame {
            ...
            .button-finished {
                ...
                margin-top: 10px; /* Add some space between the paragraphs and the button */
